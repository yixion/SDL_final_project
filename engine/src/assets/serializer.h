...
namespace fuse {
    struct asset_serializer {
        ...
        // serialize font assets
        FUSE_INLINE void serialize_font(YAML::Emitter& em) {
        ...
        // serialize animation assets
        FUSE_INLINE void serialize_animation(YAML::Emitter& em) {
        ...
        // serialize audio assets
        FUSE_INLINE void serialize_audio(YAML::Emitter& em) {
        ...
        // serialize texture assets
        FUSE_INLINE void serialize_texture(YAML::Emitter& em) {
